...
class UNFC_List_Table { // gitlost
	...
	public function __construct( $args = array() ) {
		global $wp_version; // gitlost
		$this->wp_less_than_4_4 = version_compare( $wp_version, '4.4', '<' ); // gitlost
...
<?php
	...
	public function views() {
		...
		if ( ! $this->wp_less_than_4_4 ) $this->screen->render_screen_reader_content( 'heading_views' ); // gitlost
...
<?php
	...
	protected function pagination( $which ) {
		...
		if ( 'top' === $which && $total_pages > 1 ) {
			if ( ! $this->wp_less_than_4_4 ) $this->screen->render_screen_reader_content( 'heading_pagination' ); // gitlost
		}
	...
	public function display() {
		...
		if ( ! $this->wp_less_than_4_4 ) $this->screen->render_screen_reader_content( 'heading_list' ); // gitlost
?>
